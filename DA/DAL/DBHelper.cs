...
namespace DA
{
    public class DBHelper
    {
        ...
        readonly SQLiteConnection _sqlConnection;
        ...
        public void ExecuteSQL(string commandText)
        {
            ...
            {
                CheckConnection();
                using SQLiteCommand sqlCommand = new(commandText, _sqlConnection);
        ...
        public DataTable CheckSQL(string commandText)
        {
            ...
            {
                CheckConnection();
                using SQLiteCommand sc = new(commandText, _sqlConnection);
                DataTable dtData = new();
                using SQLiteDataAdapter sda = new(sc);
                sda.Fill(dtData);
                return dtData;
            }
        }
        ...
        public void ExecuteProcedure(string procedureName, params object[] parameters)
        {
            ...
            {
                CheckConnection();
                using SQLiteCommand sc = new(procedureName, _sqlConnection);
        ...
        public DataTable CheckProcedure(string procedureName, params object[] parameters)
        {
            ...
            {
                CheckConnection();
                using SQLiteCommand sc = new(procedureName, _sqlConnection);    // using语句简化版，省去了大括号
                sc.CommandType = CommandType.StoredProcedure;
                if (parameters != null) sc.Parameters.AddRange(parameters);
                DataTable dtData = new();
                using SQLiteDataAdapter sda = new(sc);
